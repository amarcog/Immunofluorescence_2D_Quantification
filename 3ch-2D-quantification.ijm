...
Auto_thres_met_ch1 = "Yen";
Auto_thres_met_ch2 = "Li";
Auto_thres_met_ch3 = "MinError";
...
run("Merge Channels...", "c1=["+titlewoext+"_"+markerCh3_name+".tif] c3=["+titlewoext+"_"+markerCh1_name+".tif] c2=["+titlewoext+"_"+markerCh2_name+".tif] keep create");
...
run("Concatenate...", "  title=[Stack] image1=["+titlewoext+"_"+markerCh1_name+".tif] image2=["+titlewoext+"_"+markerCh2_name+".tif] image3=["+titlewoext+"_"+markerCh3_name+".tif] image4=["+titlewoext+"_Mergedapi_adj_scale.tif]");
...
run("Concatenate...", "  title=[Stack] image1=["+titlewoext+"_"+markerCh1_name+"-Mask.tif] image2=["+titlewoext+"_"+markerCh2_name+"-Mask.tif] image3=["+titlewoext+"_"+markerCh3_name+"-Mask.tif]");
selectWindow("Stack");run("Make Montage...", "columns=3 rows=1 scale=1 first=1 last=4");
